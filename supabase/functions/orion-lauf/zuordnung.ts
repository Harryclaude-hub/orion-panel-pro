...
const PM_BEREICH: Record<string, string> = {
   ...
   * Aufgenommen wurde nur, was EINDEUTIG zu genau einem Bereich gehoert.
   * Bewusst NICHT aufgenommen: der Sammeltag 'sports' (1887 Maerkte)
   * sowie 'baseball', 'basketball' und 'football' - Oberkategorien, die
   * Maerkte mehrerer Bereiche mischen wuerden. Die Bereichstrennung ist
   * Schutz, kein Formalismus (Fehlpaarung vom 11.8.: Eintracht Frankfurt
   * im Fussball gegen Eintracht Frankfurt in League of Legends). */
